...
public class QuizBusiness {
	...
	private static Logger LOGGER = LoggerFactory.getLogger(QuizBusiness.class);
	 ...
	 */
	public QuizBusiness(FilmeClientImpl filmeClient, QuizRepository quizRepository, UsuarioRepository usuarioRepository) {
	...
	public List<FilmeDTO> getFilmesAleatorios(String temaFilme) {
		ListFilmesDTO filmes = null;
		do {
			filmes = filmeClient.getFilmes(temaFilme);
		} while (! filmes.getResponse());
